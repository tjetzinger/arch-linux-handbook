#!/bin/bash
# ============================================================
# Arch Linux Installation - Step 1: Disk Partitioning (X250)
# ============================================================
...
echo "=============================================="
echo "Arch Linux Installation - Disk Setup (X250)"
echo "=============================================="
echo ""
...
# Create mount points
mkdir -p /mnt/{boot,.snapshots,home,var/log,var/cache,var/tmp}
